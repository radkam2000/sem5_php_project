...
<template id="template-message">
	...
	<div class="message">
		<div class="timestamp"><slot name="timestamp" /></div>
		<div class="username"><slot name="username" /></div>
		<div class="content"><slot name="content" id="content" /></div>
...
const update = async () => {
    try {
		...
		const {scrollTop} = messagesScroll; // const scrollTop = messagesScroll.scrollTop;
